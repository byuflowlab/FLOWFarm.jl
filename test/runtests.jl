...
@testset "General Models" begin
    ...
    @testset "Point velocity" begin
        ...
        wakedeficitmodel = ms1.wake_deficit_model
        wakedeflectionmodel = ms1.wake_deflection_model
        wakecombinationmodel = ms1.wake_combination_model

        windfarm = pd1.wind_farm
        windresource = pd1.wind_resource
        windfarmstate = pd1.wind_farm_states[1]
