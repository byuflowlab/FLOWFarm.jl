...
function aep_wrapper(x, params)
    ...
    # calculate AEP
    AEP = params.obj_scale*ff.calculate_aep(turbine_x, turbine_y, params.turbine_z, params.rotor_diameter,
...
function opt_example_2()

    # import model set with wind farm and related details
    filename = "./model_sets/model_set_6.jl"
    model_set, windresource, power_models, ct_models, turbine_x, turbine_y, turbine_z, turbine_yaw, 
        rotor_diameter, hub_height, cut_in_speed, cut_out_speed, rated_speed, rated_power,
        generator_efficiency, rotor_points_y, rotor_points_z = ff.return_model_set(filename)
