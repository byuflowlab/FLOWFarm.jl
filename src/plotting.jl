# TODO: Replace this file using RecipesBase.jl
...
# """
#     plotwindresource!(ax::Array, windresource::DiscretizedWindResource; roundingdigits=[1,3], fill=false, alpha=0.5, colors=["b", "b"], fontsize=8, edgecolor=nothing, rlabel_position=-45)
...
# - `windresource::DiscretizedWindResource`: wind rose information
...
# """
# function plotwindresource!(windresource::DiscretizedWindResource; ax::Array=[], roundingdigits=[1,3], fill=false, alpha=0.5, colors=["b", "b"], fontsize=8, edgecolor=nothing, rlabel_position=-45, titles=["Wind Speed", "Wind Probability"])
